  ...
  return (
    <div className="corte-container">
      ...
      <section className="corte-section">
        ...
        <div className="image-container">
          <img src="/assets/2.9.png" alt="Condiciones térmicas ideales" className="corte-image" />
        </div>
      </section>
      ...
      <section className="corte-section">
        ...
        <div className="image-container">
          <img src="/assets/2.3.png" alt="Dibujos de patrones sobre papel" className="corte-image" />
        </div>
      </section>
      ...
      <section className="corte-section">
        ...
        <div className="image-container">
          <img src="/assets/2.5.png" alt="Equipo de protección personal para corte" className="corte-image" />
        </div>
      </section>
      ...
      <section className="corte-section">
        ...
        <div className="image-container">
          <img src="/assets/2.10.png" alt="Proceso de extendido de tela" className="corte-image" />
        </div>
      </section>
      ...
      <section className="corte-section">
        ...
        <div className="image-container">
          <img src="/assets/2.11.png" alt="Uso de la máquina de corte" className="corte-image" />
        </div>
      </section>
      ...
      <section className="corte-section">
        ...
        <div className="image-container">
          <img src="/assets/2.12.png" alt="Clasificación de piezas cortadas" className="corte-image" />
        </div>
      </section>
      ...
      <section className="corte-section">
        ...
        <div className="image-container">
          <img src="/assets/2.13.png" alt="Almacenamiento de telas" className="corte-image" />
        </div>
      </section>
      ...
      <section className="corte-section">
        ...
        <div className="image-container">
          <img src="/assets/2.8.png" alt="Mantenimiento de la máquina de corte" className="corte-image" />
        </div>
      </section>
      ...
      <section className="corte-section">
        ...
        <div className="image-container">
          <img src="/assets/2.15.png" alt="Control de calidad en el corte" className="corte-image" />
        </div>
      </section>
      ...
      <section className="corte-section">
        ...
        <div className="image-container">
          <img src="/assets/2.6.png" alt="Optimización de materiales" className="corte-image" />
        </div>
      </section>
    </div>
  );
